...
def main():
    ...
    test_results["performance"] = run_test_suite(
        "performance", 
        "Тесты производительности"
    )
    
    # Тесты безопасности
    test_results["security"] = run_test_suite(
        "security", 
        "Тесты безопасности"
    )
    ...
    print(f"📊 Покрытие кода: htmlcov/index.html")
    print(f"📋 Сводный отчет: reports/summary_report.json")
