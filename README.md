...
🏪 **НОВИНКА в версии 3.2.0 - ПРОФЕССИОНАЛЬНЫЙ МАРКЕТПЛЕЙС БОТОВ:**
...
#### 🏪 Профессиональный маркетплейс ботов (NEW in v3.2.0)
...
🏪 **Маркетплейс ботов доступен по адресу:** http://localhost:60183/marketplace *(публичный доступ)*
...
🎯 **НОВОЕ в v3.2.0:** Добавлен профессиональный маркетплейс ботов с публичными страницами, мобильной адаптацией и социальными функциями! Создавайте красивые карточки ботов и делитесь ими с пользователями.
...
### 🏪 Marketplace API (Публичные endpoints)
